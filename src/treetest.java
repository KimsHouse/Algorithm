...
public class treetest {
    ...
    public static void getPreOrder(int inO_start, int inO_end, int poO_start, int poO_end) {
        System.out.println(inO_start+" "+inO_end+" "+poO_start+" "+poO_end);
        ...
        System.out.println("po0_e : "+poO_end);
        ...
        System.out.println("ridx - in0_s : "+rootIdx+" - "+inO_start);
        System.out.println("left : "+left);

        System.out.println();
        System.out.println("좌측 : "+inO_start+" "+(rootIdx-1)+" "+poO_start+" "+(poO_start+left-1));
        //좌측 자식 노드들을 구한다.
        getPreOrder(inO_start, rootIdx-1, poO_start, poO_start+ left-1);

        System.out.println("우측 : "+(rootIdx-1)+" "+inO_end+" "+(poO_start + left)+" "+(poO_end - 1));
        // 우측 자식 노드들을 구한다.
